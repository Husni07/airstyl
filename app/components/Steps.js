      ...
      <div className="container">
        ...
        <div className="grid gap-6">
          <div className="flex items-center p-4 overflow-hidden transition duration-300 w-fit md:gap-10 md:p-8 hover:shadow-md hover:rounded-md">
            <div className="p-2 rounded-lg shadow-lg md:p-4 rotate-12">
              <Image
            ...
            <div className="px-2 md:px-5 py-1 md:py-3 lg:w-[700px]">
              <h3 className="text-xl italic font-semibold text-gray-500 uppercase md:mb-3 lora md:text-2xl">
                01.
              </h3>
              <h3 className="mb-1 text-lg font-medium uppercase md:mb-2 lora md:text-2xl">
                Pilih penginapan
              </h3>
              <span className="text-base text-gray-500 open-sans md:text-lg">
