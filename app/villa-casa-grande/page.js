        ...
        <div className="py-8 md:grid md:grid-cols-3 sm:py-16">
          <div className="flex flex-col h-full col-span-2 text-left md:mt-0">
            ...
            <p className="font-medium open-sans text-sm md:w-[70%] flex flex-col">
              Valencia, Jl. Casa Grande Residence No.119, Jenengan, Maguwoharjo,
      ...
      <div className="items-center gap-8 px-4 py-8 md:grid xl:gap-16 sm:py-16">
        <div className="flex flex-col h-full text-left md:mt-0">
          ...
          <p className="font-medium open-sans text-md text-secondary md:text-lg">
            Villa Casa Grande menawarkan pengalaman menginap yang mewah dan
            ...
            yang mencari tempat berlibur yang eksklusif. Villa Casa Grande
        ...
        <div className="container">
          <div className="items-center gap-8 px-4 py-8 md:grid md:grid-cols-2 lg:mt-24 xl:gap-16 sm:py-16">
            <div className="flex flex-col h-full text-left md:mt-0">
              ...
              <p className="font-medium open-sans text-sm md:w-[70%] flex flex-col">
                Valencia, Jl. Casa Grande Residence No.119, Jenengan,
          ...
          <div className="flex px-4">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3953.264852994191!2d110.4200082!3d-7.7617114!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e7a59c09d1cde5f%3A0x9c371aaee553a142!2sVilla%20Exclusive%20Casa%20Grande!5e0!3m2!1sid!2sid!4v1723011385517!5m2!1sid!2sid"
              width={800}
              height={600}
              loading="lazy"
