...
const image = [
  {
    data: "/image/griya-iromejan/property.webp",
  },
  {
    data: "/image/griya-iromejan/ruang-tamu.webp",
  },
  {
    data: "/image/griya-iromejan/kamar-tidur.webp",
  },
  {
    data: "/image/griya-iromejan/dapur.webp",
  },
  {
    data: "/image/griya-iromejan/image-1.webp",
  },
  {
    data: "/image/griya-iromejan/image-2.webp",
  },
];
        ...
        <div className="py-8 md:grid md:grid-cols-3 sm:py-16">
          <div className="flex flex-col h-full col-span-2 text-left md:mt-0">
            ...
            <p className="font-medium open-sans text-sm md:w-[70%] flex flex-col">
              Jl. Samironobaru, Samirono, Caturtunggal, Kec. Depok, Kabupaten
              Sleman, Daerah Istimewa Yogyakarta 55281
            </p>
          </div>
          <div className="sticky flex justify-between w-full mt-4 md:justify-normal md:flex-col md:items-end top-4">
      ...
      <div className="items-center gap-8 px-4 py-8 md:grid xl:gap-16 sm:py-16">
        <div className="flex flex-col h-full text-left md:mt-0">
          ...
          <p className="font-medium open-sans text-md text-secondary text-justify md:text-lg">
            Griya Iromejan menawarkan pengalaman menginap yang mewah dan nyaman
            ...
            pasangan yang mencari tempat berlibur yang eksklusif. Griya Iromejan
        ...
        <div className="container">
          <div className="items-center gap-8 px-4 py-8 md:grid md:grid-cols-2 lg:mt-24 xl:gap-16 sm:py-16">
            ...
            <div className="hidden w-full px-4 md:flex md:justify-end">
              <Link
                href="https://maps.app.goo.gl/fZv6nkkaFKfHWFpK8"
                target="_blank"
          ...
          <div className="flex px-4">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3953.0904278018184!2d110.3834997!3d-7.7802364!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e7a595e28389193%3A0x546b1214d3870174!2sGriya%20Iromejan%20(KOST%20PUTRI)!5e0!3m2!1sid!2sid!4v1723161608674!5m2!1sid!2sid"
              width={800}
              height={600}
              loading="lazy"
