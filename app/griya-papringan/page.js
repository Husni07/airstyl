...
const image = [
  {
    data: "/image/griya-papringan/property.webp",
  },
  {
    data: "/image/griya-papringan/ruang-tengah.webp",
  },
  {
    data: "/image/griya-papringan/ruang-tamu.webp",
  },
  {
    data: "/image/griya-papringan/kamar-tidur.webp",
  },
  {
    data: "/image/griya-papringan/dapur.webp",
  },
  {
    data: "/image/griya-papringan/kamar-mandi.webp",
  },
  {
    data: "/image/griya-papringan/image-1.webp",
  },
  {
    data: "/image/griya-papringan/image-2.webp",
  },
];
        ...
        <div className="py-8 md:grid md:grid-cols-3 sm:py-16">
          <div className="flex flex-col h-full col-span-2 text-left md:mt-0">
            ...
            <p className="font-medium open-sans text-sm md:w-[70%] flex flex-col">
              Jl. Petung No.10, Papringan, Caturtunggal, Kec. Depok, Kabupaten
      ...
      <div className="items-center gap-8 px-4 py-8 md:grid xl:gap-16 sm:py-16">
        <div className="flex flex-col h-full text-left md:mt-0">
          ...
          <p className="font-medium open-sans text-md text-secondary text-justify md:text-lg">
            ...
            pasangan yang mencari tempat berlibur yang eksklusif. Griya Papringan
        ...
        <div className="container">
          <div className="items-center gap-8 px-4 py-8 md:grid md:grid-cols-2 lg:mt-24 xl:gap-16 sm:py-16">
            ...
            <div className="hidden w-full px-4 md:flex md:justify-end">
              <Link
                href="https://maps.app.goo.gl/ZykgbvGsJVXHxW2W8"
                target="_blank"
          ...
          <div className="flex px-4">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3953.084384020828!2d110.3958109!3d-7.780877500000001!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e7a59c476e746a9%3A0xda823678c37a10c6!2sGriya%20Papringan!5e0!3m2!1sid!2sid!4v1723160995906!5m2!1sid!2sid"
              width={800}
              height={600}
              loading="lazy"
